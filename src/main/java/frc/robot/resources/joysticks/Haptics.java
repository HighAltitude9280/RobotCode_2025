...
public class Haptics {
     ...
     *
     * @param intensity  The intensity of the rumble, 0-1.
     * @param period     The time between the starting of the rumble (seconds).
     * @param duration   The duration of the rumble (seconds).
    ...
    public void startPeriodicRumble(double intensity, double period, double duration,
            GenericHID.RumbleType rumbleType) {
