...
public class WristGoToTarget extends Command {
  /** Creates a new WristMantainTo. */

  double maxPower, target;

  public WristGoToTarget(double maxPower) {
  ...
  public WristGoToTarget(double angleTarget, double maxPower) {
    addRequirements(Robot.getRobotContainer().getWrist());
  ...
  public boolean isFinished() {
    return Robot.getRobotContainer().getWrist().onTarget();
  }
}
