...
public class ScoreCoral extends SequentialCommandGroup {
        ...
        public ScoreCoral(REEF_HEIGHT heightUp) {
                ...
                double wristTargetUp =
                                HighAltitudeConstants.WRIST_CORAL_POSITIONS[heightUp.getID()];

                REEF_HEIGHT heightDown = REEF_HEIGHT.BOTTOM;
                double liftTargetDown =
                                HighAltitudeConstants.LIFT_CORAL_POSITIONS[heightDown.getID()];
                double wristTargetDown =
                                HighAltitudeConstants.WRIST_CORAL_POSITIONS[heightDown.getID()];

                // Add your commands in the addCommands() call, e.g.
                // addCommands(new FooCommand(), new BarCommand());
                if (heightUp != REEF_HEIGHT.TOP) {
                        addCommands(new LiftGoToTarget(HighAltitudeConstants.LIFT_MAX_POWER,
                                        liftTargetUp, HighAltitudeConstants.LIFT_ARRIVE_OFFSET),
                        ...
                        addCommands(new LiftGoToTarget(HighAltitudeConstants.LIFT_MAX_POWER,
                                        ...
                                        new ParallelRaceGroup(new LiftDefaultCommand(
                                                        ...
                                                        HighAltitudeConstants.LIFT_ARRIVE_OFFSET),
                                                        new WristGoToTarget(wristTargetUp
                                                                        - HighAltitudeConstants.WRIST_L4_OFFSET,
                                                                        HighAltitudeConstants.WRIST_DRIVE_SPEED)),
