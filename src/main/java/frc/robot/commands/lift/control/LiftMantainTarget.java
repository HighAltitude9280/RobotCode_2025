...
package frc.robot.commands.lift.control;

import edu.wpi.first.wpilibj2.command.Command;
import frc.robot.Robot;

/* You should consider using the more terse Command factories API instead https://docs.wpilib.org/en/stable/docs/software/commandbased/organizing-command-based.html#defining-commands */
public class LiftMantainTarget extends Command {
  /** Creates a new LiftMantainTarget. */

  double maxPower, target;

  public LiftMantainTarget(double maxPower) {
  ...
  public LiftMantainTarget(double maxPower, double targetMeters) {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(Robot.getRobotContainer().getLift());
