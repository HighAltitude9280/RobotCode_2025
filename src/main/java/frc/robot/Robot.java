...
public class Robot extends TimedRobot {
  ...
  private static boolean coralL1 = true;
  ...
  public static boolean isCoralL1() {
    return coralL1;
  }
  ...
  void putSmartDashboardMatchMode() {
    ...
    SmartDashboard.putBoolean("Field oriented mode",
        getRobotContainer().getSwerveDriveTrain().getIsFieldOriented());
  }
