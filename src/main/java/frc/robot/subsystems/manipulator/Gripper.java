...
public class Gripper extends SubsystemBase {
  ...
  public Gripper() {
    gripperMotors = new HighAltitudeMotorGroup(RobotMap.GRIPPER_MOTOR_PORTS,
        RobotMap.GRIPPER_INVERTED_MOTORS_PORTS, RobotMap.GRIPPER_MOTOR_TYPES);
  ...
  public void periodic() {
    ...
    SmartDashboard.putBoolean("Digital Input Gripper", getDigitalInput());
  }
}
